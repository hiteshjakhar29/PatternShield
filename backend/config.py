...
class Config:
    ...
    CORS_ORIGINS: List[str] = field(
        default_factory=lambda: _split_list(os.getenv("CORS_ORIGINS", "http://localhost:3000,http://localhost:5000"))
    )
    ...
    ALLOWED_API_KEYS: List[str] = field(default_factory=lambda: _split_list(os.getenv("ALLOWED_API_KEYS")))
